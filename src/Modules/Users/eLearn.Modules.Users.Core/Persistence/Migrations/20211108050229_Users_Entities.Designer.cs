...
namespace eLearn.Modules.Users.Core.Persistence.Migrations
{
    ...
    [Migration("20211108050229_Users_Entities")]
            ...
            modelBuilder.Entity("eLearn.Modules.Users.Core.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Yao",
                            LatestUpdatedOn = new DateTimeOffset(new DateTime(2021, 11, 1, 4, 33, 39, 189, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0)),
                            LockoutEnabled = true,
                            NormalizedEmail = "SYSTEM@BIOWELLACADEMY.COM",
                            NormalizedUserName = "SYSTEM@BIOWELLACADEMY.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEL2tZZGiftZt3LUZjK4VWKo9sieuP2LDgUpaKfX4J9EgvKMai3trjbmvENBQCGDJjw==",
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            LastName = "Huang",
                            LatestUpdatedOn = new DateTimeOffset(new DateTime(2021, 11, 2, 4, 33, 39, 190, DateTimeKind.Unspecified), new TimeSpan(0, 7, 0, 0, 0)),
                            LockoutEnabled = true,
